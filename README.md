...
Для настройки и сборки прошивки ознакомьтесь с [инструкцией](/Instruction.pdf). Так же вам могут быть полезны следующие программы для заливки прошивки по DFU:

...
Плата поддерживает и протестированна с прошивкой на базе Marlin 2.1.2.5. В репозитории вы можете найти как сами исходники модифицированной прошивки 
...
Для компиляции использовался <a href="https://code.visualstudio.com">Visual Studio Code</a> с установленным PlatformIO.
Для настройки и сборки прошивки ознакомьтесь с [инструкцией](/files/Instruction.pdf). Так же вам могут быть полезны следующие программы для заливки прошивки по DFU:
...
В репозитории вы можете найти как сами исходники прошивки. Для настройки и сборки прошивки ознакомьтесь с [инструкцией](/files/Instruction.pdf)

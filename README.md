...
Для настройки и сборки прошивки ознакомьтесь с [инструкцией](/docs/Instruction.pdf). Так же вам могут быть полезны следующие программы для заливки прошивки по DFU:
...
В репозитории вы можете найти как сами исходники прошивки. Для настройки и сборки прошивки ознакомьтесь с [инструкцией](/docs/Instruction.pdf)

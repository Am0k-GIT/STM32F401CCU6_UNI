...
#endif
#if ANY_THERMISTOR_IS(58) // Pull-up = 1 kOhm, "Unknown resistor from AliExpress for hotend"
  #include "thermistor_58.h"
#endif
#if ANY_THERMISTOR_IS(59) // Pull-up = 1 kOhm, "Unknown resistor from AliExpress for hotbead"
